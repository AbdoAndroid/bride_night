...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  _register() async {
    ...
    User user =User(name: 'Ahmed',id: ' ',normalUser: true,userName: userNameController.text,mobile: '',password: passwordController.text); /*await login(context, userNameController.text, passwordController.text);*/
    register(user);
    if (user != null) {
      if (user.id !='') {
        ...
        await Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => HomePage(user: user)));
      } else {
        await hideProgress();
